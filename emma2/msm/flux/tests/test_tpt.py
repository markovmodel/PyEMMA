...
class TestTPTDense(unittest.TestCase):
    def setUp(self):
        ...
        import emma2.msm.analysis.dense.birth_death_chain
        self.bdc=emma2.msm.analysis.dense.birth_death_chain.BirthDeathChain(q, p)
...
class TestTPTSparse(unittest.TestCase):
    def setUp(self):
        ...
        import emma2.msm.analysis.sparse.birth_death_chain
        self.bdc=emma2.msm.analysis.sparse.birth_death_chain.BirthDeathChain(q, p)
