...
def tpt(T, A, B, mu=None, qminus=None, qplus=None, rate_matrix=False):
    ...
    Uses TPT (originally introduced in [1]) in its discrete form [2]. Here,
    we use the transition matrix formulation described in [3]. 
    ...
    Returns
    -------
    tpt: emma2.msm.analysis.ReactiveFlux object
...
def mfpt(totflux, pi, qminus):
    r"""Mean first passage time for reaction A to B. Equal to the inverse rate in [1]
