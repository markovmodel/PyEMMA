...
from emma2.msm.analysis import rdl_decomposition, timescales, fingerprint_correlation, fingerprint_relaxation
...
class TestFingerprintCorrelationDense(unittest.TestCase):
    ...
    def test_expectation(self):
        tsn, exp_ampn=fingerprint_correlation(self.T, self.obs1, obs2=self.one_vec)
...
class TestFingerprintRelaxationDense(unittest.TestCase):
    ...
    def test_expectation(self):
        tsn, exp_ampn=fingerprint_relaxation(self.T, self.p0, self.obs1)
        self.assertTrue(np.allclose(tsn, self.ts))
        self.assertTrue(np.allclose(exp_ampn, self.exp_amp))
...
class TestFingerprintCorrelationSparse(unittest.TestCase):
...
class TestFingerprintRelaxationSparse(unittest.TestCase):
