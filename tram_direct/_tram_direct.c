...
#define THERMOTOOLS_TRAM_PRIOR 1.0E-12
//1.0E-10
...
//                                               lagrangian_mult[Kj]*biased_conf_weights[Ki]/
//                                              (lagrangian_mult[Ki]*biased_conf_weights[Kj]));
                    }
                }
            ...
            for(j=0; j<n_conf_states; ++j)
            {
                ...
                if(i == j) {
                    ...
                    if(0 < CCT_Kij) {
                        ...
                        /*if(lagrangian_mult[Ki]==0) fprintf(stderr, "R:Warning nu[%d,%d]=0\n",K,i);
                        if(lagrangian_mult[Kj]==0) fprintf(stderr, "R:Warning nu[%d,%d]=0\n",K,j);*/
