...
We store the following data when you access this page, as well when you import the
Python package. These information will be submitted automatically. In detail the following
...
Disable online release checking
-------------------------------
If you do not want to PyEMMA to check for a new relase upon import, you can disable this feature
by setting the following configuration flag:
